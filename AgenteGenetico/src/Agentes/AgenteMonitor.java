...
public class AgenteMonitor extends Agent {
    ...
    protected void takeDown() {
        System.out.print("Agente 1 muerto\n");
    }
...
//        boolean terminar = false;
        ...
        public void action() {
            ...
            AlgorimoGenetico algoritmoGenetico = new AlgorimoGenetico();
            IChromosome mejorIndividuo = algoritmoGenetico.iniciarAG(4, 4, 2);
            int mensaje = construirMensaje(mejorIndividuo);
            Mensajes.Mensaje.enviarMSJ1(getAgent(), "AgenteMonitor2",
                    "idAM1-AM2", ACLMessage.INFORM, true, "Mensaje para el agente 2:" + mensaje, null,mensaje );
            doDelete();
        }
