...
public class AlgorimoGenetico {
    ...
    private Configuration configuracion(int tamanioPoblacion) {
        ...
        try {
            ...
            Logger.getLogger(AlgorimoGenetico.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public IChromosome iniciarAG(int tamanioPoblacion, int generaciones, int evoluciones) {
        ...
        System.out.println("*********Mejor individuo Agente monitor 1*********");
